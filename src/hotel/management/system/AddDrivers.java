...
public class AddDrivers extends JFrame implements ActionListener{
	...
	l1.setBounds(64, 75, 102, 22);
	contentPane.add(l1);
        
        
        t1 = new JTextField();
	t1.setBounds(174, 75, 156, 20);
	contentPane.add(t1);
	...
	l2.setBounds(64, 115, 102, 22);
	contentPane.add(l2);
        
        t2 = new JTextField();
	t2.setBounds(174, 115, 156, 20);
	contentPane.add(t2);
	...
	l3.setBounds(64, 155, 102, 22);
	contentPane.add(l3);
        
        comboBox = new JComboBox(new String[] { "Male", "Female" });
	comboBox.setBounds(176, 155, 154, 20);
	...
	contentPane.add(l4);
        ...
        t3 = new JTextField();
	t3.setBounds(174, 195, 156, 20);
	contentPane.add(t3);

        JLabel l5 = new JLabel("Car Brand");
	l5.setForeground(new Color(25, 25, 112));
	l5.setFont(new Font("Tahoma", Font.BOLD, 14));
	l5.setBounds(64, 235, 102, 22);
	contentPane.add(l5);


        t4 = new JTextField();
	t4.setBounds(174, 235, 156, 20);
	contentPane.add(t4);
	...
	comboBox_1.setBounds(176, 275, 154, 20);
	...
	l7.setBounds(64, 315, 102, 22);
	contentPane.add(l7);


        t5 = new JTextField();
	t5.setBounds(174, 315, 156, 20);
	contentPane.add(t5);
