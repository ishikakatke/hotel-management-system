...
public class Room extends JFrame {
	...
	public Room() throws SQLException {
		...
		lblRoomType.setBounds(105, 15,90, 14);
		contentPane.add(lblRoomType);
                
		lblAvailability = new JLabel("Availability");
		lblAvailability.setBounds(215, 15, 69, 14);
		...
		lblNewLabel.setBounds(432, 15, 46, 14);
		contentPane.add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("Bed Type");
		lblNewLabel_1.setBounds(545, 15, 76, 14);
		contentPane.add(lblNewLabel_1);

		
		lblId = new JLabel("Room Number");
		lblId.setBounds(5, 15, 90, 14);
