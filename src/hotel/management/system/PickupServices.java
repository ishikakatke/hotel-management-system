...
public class PickupServices extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PickupServices frame = new PickupServices();
	 ...
	 * @throws SQLException 
	 */
	public PickupServices() throws SQLException {
		...
		JLabel lblInfo = new JLabel("Driver_Name");
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String SQL = "select * from driver where car_brand = '"+c1.getSelectedItem()+"'";
				try{
		...
		lblNewLabel.setBounds(155, 208, 46, 14);
		...
		JLabel lblTypeOfDriver = new JLabel("Car_Company");
		lblTypeOfDriver.setBounds(360, 208, 80, 14);
		contentPane.add(lblTypeOfDriver);
		
		JLabel lblDateOfThe = new JLabel("Car_Brand");
