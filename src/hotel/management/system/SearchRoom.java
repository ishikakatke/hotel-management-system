...
public class SearchRoom extends JFrame {
	...
	public SearchRoom() throws SQLException {
		...
		lblRoomNumber.setBounds(5, 162, 96, 14);
		contentPane.add(lblRoomNumber);
		
                JLabel lblRoomType = new JLabel("Room Type");
		lblRoomType.setBounds(115, 162, 120, 14);
		contentPane.add(lblRoomType);
                
		JLabel lblRoomAvailable_1 = new JLabel("Availability");
		lblRoomAvailable_1.setBounds(235, 162, 120, 14);
		contentPane.add(lblRoomAvailable_1);
                
                JLabel lblCleanStatus = new JLabel("Clean Status");
		lblCleanStatus.setBounds(350, 162, 96, 14);
		contentPane.add(lblCleanStatus);
		
		JLabel lblPrice_1 = new JLabel("Price");
		lblPrice_1.setBounds(465, 162, 46, 14);
		contentPane.add(lblPrice_1);
                
                JLabel l1 = new JLabel("Bed Type");
		l1.setBounds(585, 162, 96, 14);
		contentPane.add(l1);
